...
const Benefits = () => {
    return (
        <section id="why-matters" className="py-24 bg-background-light dark:bg-background-dark overflow-hidden">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex flex-col lg:flex-row gap-12">
                    ...
                    {/* Right Content (Signature Card) */}
                    <div className="lg:w-1/3 mt-12 lg:mt-0">
                        <div className="bg-primary p-6 lg:p-8 rounded-3xl text-white h-full relative overflow-hidden group">
                            ...
                            <div className="space-y-6 relative z-10">
                                ...
                                <div className="pt-4">
                                    <img
                                        ...
                                        className="rounded-xl opacity-60 grayscale hover:grayscale-0 transition-all duration-500 h-24 w-full object-cover"
