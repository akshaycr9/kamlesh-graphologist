...
const Testimonials = () => {
    return (
        <section id="testimonials" className="py-24 bg-background-light dark:bg-slate-900/50">
                    ...
                    <div className="bg-white dark:bg-slate-800 p-8 rounded-3xl border border-slate-100 dark:border-slate-700 relative shadow-sm">
                        ...
                        <div className="flex items-start gap-6 mb-8">
                            <img
                                ...
                                className="w-20 h-20 rounded-xl object-cover"
                                src="https://lh3.googleusercontent.com/aida-public/AB6AXuDrM6f3v_3MYD2VwY6gbiPxhcpOnaXKjDL56Ov2jveyzMe54GhWlgew2KNW-kQ1Ws-WEKgNSWp_d2eU2LQJIhO2oBBzTp72vpPR4MlilR1OC9QExG_pAlTqLYMdH85CM1uLRg31VxXMHdUA57KNdR48fMpvXGR3gBRLXkLOB-hCP3X5QBL9_QLSK1f7GDF00XzftqBGScjLBWuiiGalBFVtq2Q86bLTXbZGE1IDF6lZj9ZrDb8adRXroWJ__8i71CXAtHBRWQlzmkp1"
                            />
                            <div>
